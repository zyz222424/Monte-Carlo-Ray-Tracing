...
public:
    /// vertices of models
    std::vector<Vec3f> m_vertices;  //模型的顶点信息
    /// normals pf triangles
    std::vector<Vec3f> m_normals;   //模型的法线信息
    /// AABB of model
    AABB m_bbox;    //模型的bounding box
...
private:
    /// triangles of models
    std::vector<AbstractObject *> m_triangles;    //模型的三角多边形
    /// KdTree of model
    KdTree m_kd_tree;   //模型的kdtree
};
